...
/**
 * @method static void 		setCachePrefix( string $prefix )
 ...
 * @method static mixed 	rememberForever( string $key, $callback )
 * @method static mixed 	remember( string $key, $ttl, $callback )
 * 
 * @since 1.0.1
 */
